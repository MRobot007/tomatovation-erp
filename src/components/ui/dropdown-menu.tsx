...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-48 overflow-hidden rounded-lg p-1 shadow-lg',
...
>(({ className, destructive, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      destructive ? 'text-danger focus:bg-danger-soft' : 'text-ink-muted focus:text-ink',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label ref={ref} className={cn('px-2 py-1.5', className)} {...props} />
))
